...
app.post("/transfer", async(req,res, next) => {
        ...
        res.json({
            ...
            sendNewBalance: sender.balance,
            recipientNewBalance: recipienet.balance,
        })
...
const server = app.listen(PORT, () => console.log(`Tiny Bank Api running on http://localhost:${PORT}...`))
